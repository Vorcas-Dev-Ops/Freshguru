    ...
    <div className="min-h-screen bg-[#f3fcef] flex items-center justify-center p-4 font-inter relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-sm mb-4 border border-emerald-50">
            <Leaf className="text-[#1a4d2e] w-8 h-8" />
          </div>
          <h1 className="text-3xl font-bold tracking-tighter logo-font text-[#1a4d2e]">Fresh Guru</h1>
